...
/**
 * ImAddTagRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class ImAddTagRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImAddTagRequest';
     ...
     * Sets toAccount
     *
     * @param string $toAccount 目标用户帐号列表
     *
     * @return $this
     */
