...
/**
 * TIMCustomElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMCustomElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMCustomElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMCustomElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMCustomElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMCustomElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMCustomElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
