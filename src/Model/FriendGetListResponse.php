...
/**
 * FriendGetListResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendGetListResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendGetListResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['infoItem'] = isset($data['infoItem']) ? $data['infoItem'] : null;
    ...
    {
        return $this->container['infoItem'];
    }

    /**
     * Sets infoItem
     *
     * @param object[]|null $infoItem 好友对象数组，每一个好友对象都包含一个 To_Account 字段和一个 SnsProfileItem 数组
     *
     * @return $this
     */
    public function setInfoItem($infoItem)
    {
        $this->container['infoItem'] = $infoItem;
     ...
     * Sets failAccount
     *
     * @param string[]|null $failAccount 返回处理失败的 UserID 列表，仅当存在失败用户时才返回该字段
     *
     * @return $this
     */
