...
/**
 * GroupAddRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class GroupAddRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupAddRequest';
     ...
     * Sets fromAccount
     *
     * @param string $fromAccount 需要为该 UserID 添加新分组
     *
     * @return $this
     */
     ...
     * Sets toAccount
     *
     * @param string[]|null $toAccount 需要加入新增分组的好友的 UserID 列表
     *
     * @return $this
     */
