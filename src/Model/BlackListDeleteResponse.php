...
/**
 * BlackListDeleteResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class BlackListDeleteResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackListDeleteResponse';
     ...
     * Sets resultItem
     *
     * @param object[]|null $resultItem 批量删除黑名单的结果对象数组
     *
     * @return $this
     */
