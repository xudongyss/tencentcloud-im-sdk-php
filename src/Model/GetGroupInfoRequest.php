...
/**
 * GetGroupInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class GetGroupInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetGroupInfoRequest';
    ...
    protected static $openAPITypes = [
        'groupIdList' => 'string[]',
        'responseFilter' => '\TencentCloud\IM\Model\GetGroupInfoRequestResponseFilter'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['groupIdList'] === null) {
            $invalidProperties[] = "'groupIdList' can't be null";
        }
     ...
     * Sets groupIdList
     *
     * @param string[] $groupIdList 需要拉取的群组列表
     *
     * @return $this
     */
     ...
     * Gets responseFilter
     *
     * @return \TencentCloud\IM\Model\GetGroupInfoRequestResponseFilter|null
     */
     ...
     * Sets responseFilter
     *
     * @param \TencentCloud\IM\Model\GetGroupInfoRequestResponseFilter|null $responseFilter responseFilter
     *
     * @return $this
     */
