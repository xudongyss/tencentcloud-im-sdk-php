...
/**
 * BlackListAddRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class BlackListAddRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackListAddRequest';
     ...
     * Sets fromAccount
     *
     * @param string $fromAccount 请求为该 UserID 添加黑名单
     *
     * @return $this
     */
     ...
     * Sets toAccount
     *
     * @param string[] $toAccount 待添加为黑名单的用户 UserID 列表，单次请求的 To_Account 数不得超过1000
     *
     * @return $this
     */
