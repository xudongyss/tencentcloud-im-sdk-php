...
/**
 * AccountDeleteResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class AccountDeleteResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountDeleteResponse';
     ...
     * Sets resultItem
     *
     * @param object[]|null $resultItem 单个帐号的结果对象数组
     *
     * @return $this
     */
