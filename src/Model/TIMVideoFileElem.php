...
/**
 * TIMVideoFileElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMVideoFileElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMVideoFileElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMVideoFileElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMVideoFileElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMVideoFileElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMVideoFileElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
