...
/**
 * FriendUpdateResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendUpdateResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendUpdateResponse';
     ...
     * Sets resultItem
     *
     * @param object[]|null $resultItem 批量更新好友的结果对象数组
     *
     * @return $this
     */
