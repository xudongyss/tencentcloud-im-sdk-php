...
/**
 * AddGroupMemberRequestMemberList Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class AddGroupMemberRequestMemberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddGroupMemberRequest_MemberList';
     ...
     * Sets memberAccount
     *
     * @param string $memberAccount 待添加的群成员 UserID
     *
     * @return $this
     */
