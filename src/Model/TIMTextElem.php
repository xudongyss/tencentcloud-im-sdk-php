...
/**
 * TIMTextElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMTextElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMTextElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMTextElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMTextElem';
     ...
     * Sets msgType
     *
     * @param string $msgType TIM 消息对象类型
     *
     * @return $this
     */
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMTextElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMTextElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
