...
/**
 * BlackListCheckRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class BlackListCheckRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackListCheckRequest';
     ...
     * Sets fromAccount
     *
     * @param string $fromAccount 需要校验该 UserID 的黑名单
     *
     * @return $this
     */
     ...
     * Sets toAccount
     *
     * @param string[] $toAccount 待校验的黑名单的 UserID 列表，单次请求的 To_Account 数不得超过1000
     *
     * @return $this
     */
     ...
     * Sets checkType
     *
     * @param string $checkType 校验模式，详情可参见 校验黑名单（校验黑名单）
     *
     * @return $this
     */
