...
/**
 * BlackListDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class BlackListDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackListDeleteRequest';
     ...
     * Sets fromAccount
     *
     * @param string $fromAccount 需要删除该 UserID 的黑名单
     *
     * @return $this
     */
     ...
     * Sets toAccount
     *
     * @param string[] $toAccount 待删除的黑名单的 UserID 列表，单次请求的 To_Account 数不得超过1000
     *
     * @return $this
     */
