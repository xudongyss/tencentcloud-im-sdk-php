...
/**
 * FriendDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendDeleteRequest';
     ...
     * Sets toAccount
     *
     * @param string[]|null $toAccount 待删除的好友的 UserID 列表，单次请求的 To_Account 数不得超过1000
     *
     * @return $this
     */
     ...
     * Sets deleteType
     *
     * @param string|null $deleteType 删除模式，详情可参见 删除好友（https://cloud.tencent.com/document/product/269/1501#.E5.88.A0.E9.99.A4.E5.A5.BD.E5.8F.8B）
     *
     * @return $this
     */
