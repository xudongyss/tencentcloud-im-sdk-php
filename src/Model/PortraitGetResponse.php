...
/**
 * PortraitGetResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class PortraitGetResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortraitGetResponse';
    ...
    protected static $setters = [
        'userProfileItem' => 'setUserProfileItem',
    ...
    protected static $getters = [
        'userProfileItem' => 'getUserProfileItem',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['userProfileItem'] = isset($data['userProfileItem']) ? $data['userProfileItem'] : null;
    ...
    /**
     * Gets userProfileItem
     *
     * @return object[]|null
     */
    public function getUserProfileItem()
    {
        return $this->container['userProfileItem'];
    }

    /**
     * Sets userProfileItem
     *
     * @param object[]|null $userProfileItem 返回的用户资料结构化信息
     *
     * @return $this
     */
    public function setUserProfileItem($userProfileItem)
    {
        $this->container['userProfileItem'] = $userProfileItem;
