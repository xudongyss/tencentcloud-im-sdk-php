...
/**
 * ForbidIllegalObjectRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class ForbidIllegalObjectRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ForbidIllegalObjectRequest';
