...
/**
 * FriendDeleteAllResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendDeleteAllResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendDeleteAllResponse';
