...
/**
 * MultiAccountImportRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class MultiAccountImportRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiAccountImportRequest';
