...
/**
 * FriendGetRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendGetRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendGetRequest';
     ...
     * Sets customSequence
     *
     * @param int|null $customSequence 上次拉好友数据时返回的 CustomSequence，如果 CustomSequence 字段的值与后台一致，后台不会返回自定义好友数据
     *
     * @return $this
     */
