...
/**
 * TIMFileElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMFileElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMFileElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMFileElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMFileElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMFileElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMFileElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
