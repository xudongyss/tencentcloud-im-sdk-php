...
/**
 * TIMImageElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMImageElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMImageElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMImageElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMImageElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMImageElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMImageElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
