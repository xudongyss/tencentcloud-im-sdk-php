...
/**
 * PortraitGetRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class PortraitGetRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortraitGetRequest';
     ...
     * Sets toAccount
     *
     * @param string[] $toAccount 需要拉取这些 UserID 的资料；注意：每次拉取的用户数不得超过100，避免因回包数据量太大以致回包失败
     *
     * @return $this
     */
