...
/**
 * TIMLocationElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMLocationElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMLocationElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMLocationElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMLocationElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMLocationElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMLocationElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
