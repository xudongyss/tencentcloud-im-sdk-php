...
/**
 * DeleteGroupMsgBySenderRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class DeleteGroupMsgBySenderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteGroupMsgBySenderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['senderAccount'] === null) {
            $invalidProperties[] = "'senderAccount' can't be null";
        }
    ...
    {
        return $this->container['senderAccount'];
    }

    /**
     * Sets senderAccount
     *
     * @param string $senderAccount 被撤回消息的发送者 ID
     *
     * @return $this
     */
