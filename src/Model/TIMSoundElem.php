...
/**
 * TIMSoundElem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class TIMSoundElem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TIMSoundElem';
    ...
    protected static $openAPITypes = [
        'msgType' => 'string',
        'msgContent' => '\TencentCloud\IM\Model\TIMSoundElemMsgContent'
    ];
    ...
    {
        $this->container['msgType'] = isset($data['msgType']) ? $data['msgType'] : 'TIMSoundElem';
     ...
     * Gets msgContent
     *
     * @return \TencentCloud\IM\Model\TIMSoundElemMsgContent
     */
     ...
     * Sets msgContent
     *
     * @param \TencentCloud\IM\Model\TIMSoundElemMsgContent $msgContent msgContent
     *
     * @return $this
     */
