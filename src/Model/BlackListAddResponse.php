...
/**
 * BlackListAddResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class BlackListAddResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackListAddResponse';
     ...
     * Sets resultItem
     *
     * @param object[]|null $resultItem 批量添加黑名单的结果对象数组
     *
     * @return $this
     */
