...
/**
 * FriendCheckResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendCheckResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendCheckResponse';
     ...
     * Sets infoItem
     *
     * @param object[]|null $infoItem 校验结果对象数组
     *
     * @return $this
     */
