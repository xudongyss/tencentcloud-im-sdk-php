...
/**
 * FriendDeleteResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendDeleteResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendDeleteResponse';
     ...
     * Sets resultItem
     *
     * @param object[]|null $resultItem 批量删除好友的结果对象数组
     *
     * @return $this
     */
