...
/**
 * GetRecentContactListGroupDeleteResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class GetRecentContactListGroupDeleteResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRecentContactListGroupDeleteResponse';
