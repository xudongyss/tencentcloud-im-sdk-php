...
/**
 * GroupMsgRecallRequestMsgSeqList Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class GroupMsgRecallRequestMsgSeqList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupMsgRecallRequest_MsgSeqList';
