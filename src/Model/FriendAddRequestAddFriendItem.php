...
/**
 * FriendAddRequestAddFriendItem Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendAddRequestAddFriendItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendAddRequest_AddFriendItem';
     ...
     * Sets groupName
     *
     * @param string|null $groupName From_Account 对 To_Account 的分组信息，添加好友时只允许设置一个分组，因此使用 String 类型即可，详情可参见 标配好友字段（https://cloud.tencent.com/document/product/269/1501#.E6.A0.87.E9.85.8D.E5.A5.BD.E5.8F.8B.E5.AD.97.E6.AE.B5）
     *
     * @return $this
     */
