...
/**
 * FriendImportRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class FriendImportRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FriendImportRequest';
    ...
    protected static $openAPITypes = [
        'fromAccount' => 'string',
        'addFriendItem' => '\TencentCloud\IM\Model\FriendImportRequestAddFriendItem[]'
    ];
     ...
     * Gets addFriendItem
     *
     * @return \TencentCloud\IM\Model\FriendImportRequestAddFriendItem[]
     */
     ...
     * Sets addFriendItem
     *
     * @param \TencentCloud\IM\Model\FriendImportRequestAddFriendItem[] $addFriendItem 好友结构体对象
     *
     * @return $this
     */
