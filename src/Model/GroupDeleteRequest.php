...
/**
 * GroupDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class GroupDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupDeleteRequest';
     ...
     * Sets fromAccount
     *
     * @param string $fromAccount 需要删除该 UserID 的分组
     *
     * @return $this
     */
