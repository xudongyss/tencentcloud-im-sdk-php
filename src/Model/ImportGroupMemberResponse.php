...
/**
 * ImportGroupMemberResponse Class Doc Comment
 *
 * @category Class
 * @package  TencentCloud\IM

 */
class ImportGroupMemberResponse extends CommonResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportGroupMemberResponse';
     ...
     * Sets memberList
     *
     * @param object[]|null $memberList 返回添加的群成员结果
     *
     * @return $this
     */
